...
.. figure:: img/LA061_Android.png
   :align: left
   :name: android-app

   Android App

.. figure:: img/LA061_IOS.png
   :align: left
   :name: ios-app

   IOS App

* :download:`Android <https://github.com/lafvintech/LAFVIN_DrawingBot_Doc/releases/download/v1.0.1/DrawingBot.apk>`
